...
export async function PUT(request: Request) {
  try {
    ...
    if (action === 'sell') {
      const { saleDate, sellerName, soldIds, remainingIdentifiers } = body;
      ...
      const result = await processHongKongBulkSale(saleDate, sellerName, soldIds, remainingIdentifiers);
